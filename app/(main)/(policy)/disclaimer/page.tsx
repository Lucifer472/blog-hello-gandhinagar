    ...
    <section className="w-full h-full flex flex-col items-start gap-y-4 py-6 basic-container px-2 sm:px-2 md:px-4 xl:px-0">
      ...
      <div className="max-w-[750px] mx-auto flex flex-col items-start gap-y-4 w-full">
        <p className="w-full text-left">
          Blog Hello Gandhinagar is a metadata-search engine, which mean that
          different search machines of Blog Hello Gandhinagar search in more
          search engines on the internet. The results that are displayed by Blog
          Hello Gandhinagar as result of a search command of a user, originate
          from other search engines. Blog Hello Gandhinagar shows the source of
          each result in its result list. It is possible that Blog Hello
          Gandhinagar shows in the search results direct links to files or web
          ...
          accessed by using the Website, Blog Hello Gandhinagar does not and
          ...
          and / or download of this material. Blog Hello Gandhinagar is never
          ...
          provided by Blog Hello Gandhinagar.
        </p>
        ...
        <p className="w-full text-left">
          Blog Hello Gandhinagar offers a shopping experience as easy as
          possible. We have relationships with various companies, organizations
          and entities whose products or services may be listed on Blog Hello
          Gandhinagar. If any of those products or services are purchased
          through the links on this website, then Blog Hello Gandhinagar may be
          compensated. It may happen that shops compensate us to help promote
          their products or services so that they are easier to find.
        </p>
      </div>
    </section>
  );
